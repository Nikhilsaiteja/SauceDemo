...
test.describe('Navigation Tests',()=>{
    ...
    test('Verify navigating to cart page from dashboard@cart@tocart', async ()=>{
    ...
    test('Verify navigating back to dashboard page from cart@cart@todashboard', async ()=>{
        const products = await DP.getAllProductNames();
...
test.describe('Product Checkout Tests',()=>{

    test('Verify removing product from cart by name@cart@remove', async ()=>{
        const products = await DP.getAllProductNames();
    ...
    test('Verify checkout process from cart to order confirmation@checkout@process', async ()=>{
        const products = await DP.getAllProductNames();
    ...
    test('Verify checkout process from cart by performing cancel in first step@checkout@cancelfirststep', async ()=>{
        const products = await DP.getAllProductNames();
        await DP.addToCartProductByName(products[2]);
        await CP.navigateToCartPage();
    ...
    test('Verify checkout process from cart by performing cancel in second step@checkout@cancelsecondstep', async ()=>{
        const products = await DP.getAllProductNames();
        await DP.addToCartProductByName(products[2]);
        await CP.navigateToCartPage();
    ...
    test('Verify finishing checkout process and order confirmation@checkout@finish', async ()=>{
        const products = await DP.getAllProductNames();
        await DP.addToCartProductByName(products[2]);
